 ...
 * CLI version: 2.11.0
 * 
 * Generated: Fri, 12 May 2023 18:47:42 GMT
 */
...
var APP_com_domain_app_lightningworkshop = (function () {
  ...
  class Api {
    static _getMovies() {
      ...
      return fetch("./../static/api/CONTENTLISTINGPAGE-PAGE".concat(num, ".json")).then(response => {
        return response.json();
      });
    }
  }

  class Component extends Lightning$1.Component {
    static _template() {
      return {
        Thumbnail: {
          x: 7.5,
  ...
  class ListComponent extends Lightning$1.Component {
    static _template() {
      return {
        HightlightedTitle: {
          x: 90,
